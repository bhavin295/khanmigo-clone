...
export default async function LandingPage() {
  ...
  return (
    ...
    >
          ...
          <RevealOnScroll>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="text-center md:text-left">
                ...
                >
                  Personalized AI tutoring that guides students to answers
                  instead of giving them away. Built for students, teachers, and
                  parents.
                </p>
              ...
              >
                ...
                >
                  {[
                    {
                      role: "ai",
                      text: "Hi! Let's tackle this together. When you see x² + 5x + 6 = 0, what's the first thing you'd try?",
                    },
                    { role: "user", text: "I think I need to factor it?" },
                    {
                      role: "ai",
                      text: "Exactly! 🎉 Now - can you find two numbers that multiply to 6 and add up to 5?",
                    },
                    { role: "user", text: "2 and 3?" },
                    {
                      role: "ai",
                      text: "Perfect! 🌟 2 × 3 = 6 and 2 + 3 = 5. So now can you write the factored form? It looks like (x + ?)(x + ?).",
                    },
                  ].map((message, index) =>
                    message.role === "ai" ? (
                      <div
          ...
          >
            ...
            {[
              ...
              >
                ...
                {index < arr.length - 1 ? (
                  <span
                    style={{ color: "rgba(15, 23, 42, 0.20)", fontSize: 16 }}
                  >
                    ·
                  </span>
                ) : null}
              ...
              {[
                {
                  icon: "🎒",
                  title: "For students",
                  desc: "Socratic AI that guides thinking, never gives away answers.",
                  background: "rgba(167,139,250,0.12)",
                  border: "rgba(167,139,250,0.22)",
                  iconBg: "rgba(167,139,250,0.16)",
                  titleColor: "#6D28D9",
                  descColor: "rgba(109,40,217,0.88)",
                },
                {
                  icon: "👩‍🏫",
                  title: "For teachers",
                  desc: "Lesson plans, quizzes, and rubrics generated in minutes.",
                  background: "rgba(45,212,191,0.12)",
                  border: "rgba(45,212,191,0.20)",
                  iconBg: "rgba(45,212,191,0.16)",
                  titleColor: "#0D9488",
                  descColor: "rgba(13,148,136,0.88)",
                },
                {
                  icon: "👨‍👩‍👧",
                  title: "For parents",
                  desc: "Full visibility into your child's learning journey.",
                  background: "rgba(255,189,46,0.14)",
                  border: "rgba(255,189,46,0.24)",
                  iconBg: "rgba(255,189,46,0.18)",
                  titleColor: "#B45309",
                  descColor: "rgba(180,83,9,0.88)",
                },
                {
                  icon: "📐",
                  title: "Math & algebra",
                  desc: "Step-by-step problem solving with hints, not answers.",
                  background: "rgba(96,165,250,0.12)",
                  border: "rgba(96,165,250,0.22)",
                  iconBg: "rgba(96,165,250,0.16)",
                  titleColor: "#2563EB",
                  descColor: "rgba(37,99,235,0.88)",
                },
                {
                  icon: "📖",
                  title: "Reading & writing",
                  desc: "Comprehension coaching and essay feedback built in.",
                  background: "rgba(255,107,107,0.12)",
                  border: "rgba(255,107,107,0.22)",
                  iconBg: "rgba(255,107,107,0.16)",
                  titleColor: "#E11D48",
                  descColor: "rgba(225,29,72,0.88)",
                },
                {
                  icon: "🛡️",
                  title: "Safe & moderated",
                  desc: "Every conversation monitored automatically for student safety.",
                  background: "rgba(167,139,250,0.10)",
                  border: "rgba(167,139,250,0.20)",
                  iconBg: "rgba(167,139,250,0.14)",
                  titleColor: "#7C3AED",
                  descColor: "rgba(124,58,237,0.84)",
                },
              ].map((card) => (
                <div
                  key={card.title}
      ...
      <section
        className="landing-section-padding"
        style={{ background: "var(--l-bg-surface)", padding: "88px 64px" }}
      >
        <RevealOnScroll>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            >
              <div>
                ...
                >
                  Our AI tutor uses the Socratic method - it never just hands
                  you the answer. Instead it breaks down your thinking, asks the
                  right follow-up questions, and helps you reach the solution
                  yourself.
                </p>
              </div>
              ...
              >
                ...
                >
                  ...
                  />
                  <span
                    style={{ fontSize: 11, color: "#2563EB", fontWeight: 900 }}
                  >
                    📐 ALGEBRA SESSION
                  </span>
                </div>
            ...
            >
              ...
              >
                ...
                >
                  <span
                    style={{ fontSize: 11, color: "#0D9488", fontWeight: 900 }}
                  >
                    📊 PROGRESS OVERVIEW
                  </span>
                </div>
              ...
              <div>
                ...
                >
                  Teachers and parents get a clear picture of what&apos;s being
                  learned and where students need help.
                </p>
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  iconBg: "rgba(167,139,250,0.16)",
                  titleColor: "#6D28D9",
                  bodyColor: "rgba(109,40,217,0.88)",
                  dot: "#7C3AED",
                  body: "Get step-by-step guidance that builds real understanding - not just the right answer.",
                  items: [
                ...
                },
                {
                  ...
                  iconBg: "rgba(45,212,191,0.16)",
                  titleColor: "#0D9488",
                  bodyColor: "rgba(13,148,136,0.88)",
                  dot: "#059669",
                  body: "Cut hours of prep time with AI-generated lesson plans, quizzes, and rubrics.",
                  items: [
                ...
                },
                {
                  ...
                  iconBg: "rgba(255,189,46,0.18)",
                  titleColor: "#B45309",
                  bodyColor: "rgba(180,83,9,0.88)",
                  dot: "#FF6B6B",
                  body: "Stay involved and informed with full visibility into your child's learning journey.",
                  items: [
                    "Real-time progress monitoring",
                    "Conversation safety log",
                ...
                >
                  ...
                  >
                    {card.items.map((item) => (
                      <div
                        key={item}
                        style={{ fontSize: 12, color: card.bodyColor }}
                      >
                        <span
                          style={{
                            width: 5,
      ...
      <section
        className="landing-section-padding"
        style={{ background: "var(--l-bg-surface)", padding: "52px 56px" }}
      >
        <RevealOnScroll>
          <div
            className="stats-grid-4"
      ...
      >
        <RevealOnScroll>
          ...
          >
            ...
            >
              Join thousands already using TutorAI. Free to start, no credit
              card needed.
            </p>
            <Link
              href="/signup"
      ...
      >
        <RevealOnScroll>
          ...
          >
            ...
            >
              © 2026 TutorAI. All rights reserved.
            </span>
